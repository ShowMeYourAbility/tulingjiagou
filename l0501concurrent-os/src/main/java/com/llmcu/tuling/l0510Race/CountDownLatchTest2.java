...
public class CountDownLatchTest2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("裁判：现在开始公布成绩：");
        CountDownLatchTest2.transcript
                .sort(Comparator.comparingInt(Sportsman::getTranscript));

        System.out.println("排名成绩单：" + CountDownLatchTest2.transcript);

        CountDownLatchTest2.transcript.clear();
    }
