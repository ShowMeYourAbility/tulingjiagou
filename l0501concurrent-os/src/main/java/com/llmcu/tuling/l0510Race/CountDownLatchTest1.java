...
/**
 * 通过CountDownLatch和CyclicBarrier实现运动员赛跑准备->发令枪开跑->到达终点计算成绩
 *
 * @author renzenggang
 */
public class CountDownLatchTest1 {
     ...
     * 设置终点屏障，⽤用于计算成绩
     */
    private static CyclicBarrier cb = new CyclicBarrier(SPORTSMAN_COUNT, () -> {

        CountDownLatchTest1.transcript
                .sort(Comparator.comparingInt(Sportsman::getTranscript));

        System.out.println("排名成绩单：" + CountDownLatchTest1.transcript);

        CountDownLatchTest1.transcript.clear();
    });
